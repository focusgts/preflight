 ...
 * Pre-seeded with realistic demo data. Will be replaced with a proper
 * database in a later milestone.
 */
...
export function getAssessmentByMigration(
  ...
  return Array.from(assessments.values()).find(
    (a) => a.migrationProjectId === migrationId,
  );
}
...
const demoMigrations: MigrationProject[] = [
  {
    ...
    sourceEnvironment: {
      platform: 'aem_6x',
      version: '6.5.17',
      url: 'https://author.acmecorp.com',
      connectionType: 'api',
      credentials: null,
      metadata: {
        javaVersion: '11',
        osgiBundle: 47,
        customComponents: 156,
      },
    },
    targetEnvironment: {
      platform: 'aem_cloud',
      organizationId: 'ACME@AdobeOrg',
      programId: 'p-42',
      environmentId: 'e-prod-1',
  ...
  },
  {
        ...
        items: [
          {
            ...
            error: null,
            processedAt: '2026-03-19T10:00:00.000Z',
          },
          {
            id: 'item-021',
            type: 'audience-migration',
            name: 'Audience to CJA Filter Migration',
            sourcePath: 'ga4://audiences',
            targetPath: 'cja://filters',
            status: 'processing',
            compatibilityLevel: CompatibilityLevel.COMPATIBLE,
            autoFixed: false,
    ...
    updatedAt: NOW,
    targetCompletionDate: '2026-04-18T00:00:00.000Z',
    completedAt: null,
  },
  {
    id: 'mig-003',
    ...
    sourceEnvironment: {
      ...
      connectionType: 'api',
      credentials: null,
      metadata: { posts: 3420, plugins: 42, theme: 'custom' },
    },
    targetEnvironment: {
      platform: 'aem_cloud',
      organizationId: 'GLOBALRETAIL@AdobeOrg',
      programId: 'p-88',
      environmentId: 'e-prod-1',
  ...
  },
  {
    ...
    targetEnvironment: {
      ...
      organizationId: 'FINSERV@AdobeOrg',
      programId: null,
      environmentId: null,
      url: null,
      credentials: null,
  ...
  },
  {
    ...
    targetEnvironment: {
      platform: 'rtcdp',
      organizationId: 'MEDTECH@AdobeOrg',
      programId: null,
      environmentId: null,
      url: 'https://experience.adobe.com',
      credentials: null,
      metadata: { sandboxName: 'prod', edition: 'B2C' },
    },
    assessment: null,
    phases: [
      {
        ...
        items: [
          {
            id: 'item-050',
            type: 'segment-migration',
            name: 'Trait to Schema Migration',
            sourcePath: 'aam://traits',
            targetPath: 'aep://schemas/profile',
            status: 'completed',
            compatibilityLevel: CompatibilityLevel.AUTO_FIXABLE,
            autoFixed: true,
            validationResult: { passed: true, checks: [], score: 98 },
            error: null,
            processedAt: '2026-03-19T14:00:00.000Z',
          },
          {
            id: 'item-051',
            type: 'segment-migration',
            name: 'Segment to AEP Audience Migration',
            sourcePath: 'aam://segments',
            targetPath: 'aep://audiences',
            status: 'processing',
            compatibilityLevel: CompatibilityLevel.COMPATIBLE,
            autoFixed: false,
            validationResult: null,
    ...
    updatedAt: NOW,
    targetCompletionDate: '2026-04-25T00:00:00.000Z',
    completedAt: null,
  },
];
